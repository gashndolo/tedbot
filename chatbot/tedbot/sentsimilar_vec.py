...
pathToBinVectors = '/Tedbotv1/bin/GoogleNews-vectors-negative300.bin'

print "Loading the data file... Please wait..."
#model1 = word2vec.Word2Vec.load_word2vec_format(pathToBinVectors, binary=True)
model1 = gensim.models.KeyedVectors.load_word2vec_format(pathToBinVectors, binary=True, limit=500000)
...
def symmetric_sentence_similarity(sentence1, sentence2):
	phraseVector1 = PhraseVector(sentence1)
	phraseVector2 = PhraseVector(sentence2)
	similarityScore = phraseVector1.CosineSimilarity(phraseVector2.vector)
